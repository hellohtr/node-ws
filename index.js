...
const UUID = process.env.UUID || '8709adf1-5c34-4f1b-87d0-2502a32dcda6'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'tuosdJ2P7spm94TrYDS5qBpSe8zKUlMh';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
const DOMAIN = process.env.DOMAIN || 'choreo.eli05021212.dpdns.org';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
